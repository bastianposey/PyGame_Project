...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Set the background color. Colors are RGB
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            self.sb.prep_ships()
            # calling prep_ships() after decreasing the value of ships_left, so the correct number of ships displays each time a ship is destroyed
            # Get rid of any remaining aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()
